...
DeepResearch采用模块化架构，由核心服务器、代理和一系列专用工具组成。系统还包括一个Jina AI集成模块，提供嵌入、重排序和分类功能。
...
| 模块名称 | 描述 | 关键功能 | 依赖关系 |
|---------|------|---------|---------|
| 核心服务器 | 处理请求并协调系统组件 | 请求处理、路由、配置管理 | 工具集、代理 |
| 代理 | 执行任务并管理工作流 | 任务执行、上下文管理、错误处理 | 工具集、评估系统 |
| 工具集 | 提供各种专用功能的工具集合 | 搜索、代码处理、文本处理、去重 | Jina AI集成 |
